...
DYNAMO_TABLE_NAME = _env("DYNAMO_TABLE_NAME", "pdf-processing-state")
...
SQS_MAX_MESSAGES = _env("SQS_MAX_MESSAGES", 10)
SQS_WAIT_TIME = _env("SQS_WAIT_TIME", 10)
PARQUET_MAX_CHUNK_SIZE_MB = _env("PARQUET_MAX_CHUNK_SIZE_MB", 128)
